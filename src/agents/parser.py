"""
src/agents/parser.py — OpenAI GPT-4o Mini structured product extraction.

Receives Markdown/JSON content chunks (ProductRaw) and returns
validated ProductData objects using OpenAI's JSON response mode.
"""
...
from src.agents.crawl4ai_scraper import ProductRaw

logger = logging.getLogger("bakkal_monitor.agents.parser")
...
def parse_chunk(raw: ProductRaw, client: OpenAI) -> list[ProductData]:
    """
